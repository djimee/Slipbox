...
set :application,             'team19' #project
set :branch,                  -> { fetch(:stage) }
set :repo_url,                'git@git.shefcompsci.org.uk:com3420-2020-21/team19/project.git' #'git@git.shefcompsci.org.uk:group-name/project-name.git'
